/- Schubfach printer — Float → Decimal.
   ...
   Pieces of the pipeline:
     ...
     - `Srtfp/Float/Bits.lean` — bit-level decomposition of a
   ...
   The single user-facing theorem is `Srtfp.Spec.correct_iff_toDecimal`
   in `Srtfp/Proofs/Correctness.lean`. It states: for any finite,
