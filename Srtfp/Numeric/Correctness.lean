/- THE THEOREMS.  Two correctness iffs, one per direction:
   ...
   `PP/Proofs/Numeric/{Correctness,ReaderCorrectness}.lean`.  Axioms at the end.
-/
...
namespace PP.Numeric.Spec

open PP.Numeric PP.Numeric.Float
...
/--
info: 'PP.Numeric.Spec.correct_iff_ofDecimal' depends on axioms: [propext, Classical.choice, Float.toBits_ofBits, Quot.sound]
-/
#guard_msgs in
#print axioms PP.Numeric.Spec.correct_iff_ofDecimal

/--
info: 'PP.Numeric.Spec.correct_iff_toDecimal' depends on axioms: [propext, Classical.choice, Float.toBits_ofBits, Quot.sound]
-/
#guard_msgs in
#print axioms PP.Numeric.Spec.correct_iff_toDecimal
