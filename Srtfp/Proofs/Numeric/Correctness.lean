...
open PP.Numeric.Schubfach (decDigitLength)
...
rich docstring) is in `PP/Numeric/Correctness.lean`, which delegates here. -/
...
The public file (`PP/Numeric/Correctness.lean`) restates the spec with
